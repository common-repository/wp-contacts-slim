    ...
    class wcp_export extends main_wcp {
        ...
        public function wcpexport_callback() {
			...
			if (isset($_POST['front_page'])) { // front end export
				$params = isset($_POST['get_params']) ? sanitize_array($_POST['get_params']) : array();
				...
				if (isset($_POST['rowrange'])) {
					...
					$filter_sel = sanitize_text_field($_POST['filter-sel']);
					$filter_val = sanitize_text_field($_POST['filter-val']);
			...
			$fields = isset($_POST['fields']) ? $this->sanitize_array($_POST['fields']) : array();
			$type = isset($_POST['output-type']) ? sanitize_text_field($_POST['output-type']) : 'csv';
			$columns = array();
