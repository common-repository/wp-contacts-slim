<?php
/*
 * Plugin Name: WP Contacts Slim
 * Plugin URI: https://www.wpcontacts.co
 * Description: Powerful and feature rich contact management: manage contacts, leads, inventory or just about anything else you need to keep track of.  Customizable and flexible.
 * Version: 1.0.0
 * Author: ScriptHat
...
// Constants
    ...
    define('SHWCP_PLUGIN_VERSION', '1.0.0');
	...
	// Gutenberg or Classic editor - load files and scripts
    add_action( 'plugins_loaded', array( $main_wcp, 'shwcp_editor_check') );

	/* Form Plugin integrations (Contact Form 7 */
