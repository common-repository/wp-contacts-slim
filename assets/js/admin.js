...
*/
	...
	// System access 
	$(document).on('click', '.system-access', function() {
		var len = $('.system-access:checked').length;
		if (len > 3) {
			return false;
		}
		if ($(this).is(':Checked')) {
			$(this).closest('tr').find('.permission-level').prop('disabled', false);
			$(this).closest('tr').find('.system-access-user').addClass('system-access-active');
		} else {
			$(this).closest('tr').find('.permission-level').prop('disabled', 'disabled');
			$(this).closest('tr').find('.permission-level').val('none');
			$(this).closest('tr').find('.system-access-user').removeClass('system-access-active');
